...
Это позволит работать над файлом с участием разных участников процесса. 

Для того чтобы начать использовать ресурс **GitHub** необходимо на нем зарегистрироваться. 


Тестовая запись на GitHub
